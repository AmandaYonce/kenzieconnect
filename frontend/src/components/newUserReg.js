      ...
      <Card style={{width: "1000px", marginLeft: "30px", marginTop: "30px"}}>
          <CardBody>
            ...
            <FormGroup>
              ...
              <FormGroup row>
                <Label for="gender" sm={2}>Select</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="dating" sm={2}>I want to see profiles for:</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey1" sm={2}>Do you have pets:</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey2" sm={2}>Do you like spicey food:</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey3" sm={2}>What is your perfect date?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey4" sm={2}>Which date activity do you prefer?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey5" sm={2}>Which star wars character are you most like?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey6" sm={2}>Do you prefer Beer, Wine or Cocktails?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey7" sm={2}>Hand on Heart, are you wearing Pjs right now?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey8" sm={2}>Are you an Early Bird or Night Owl</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey9" sm={2}>If age is a state of mind, which category best describes you?</Label>
                <Col sm={10}>
            ...
            <FormGroup row>
                <Label for="survey10" sm={2}>If you were a breed of dog, which would you be? </Label>
                <Col sm={10}>
                <Input type="select" name="survey10" id="survey10">
                    ...
                    <option>German Shepherd – poised and elegant but rather hardy</option>
                    <option>Poodle – beautifully presented but a bit of a poser</option>
                    <option>Golden Retriever – warm, cuddly and great with children</option>
